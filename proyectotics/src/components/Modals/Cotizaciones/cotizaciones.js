...
import AnadirVenta from '../Ventas.ventas/AnadirVenta';
import ModalVermas from '../Ventas.ventas/ModalVermas';
    ...
    return (
        ...
        >
            <Box sx={{ ...style,
                ...
                <AnadirVenta open={childOpen} handleClose={handleChildClose} />
                <ModalVermas open={detailOpen} handleClose={handleDetailClose} cotizacionSelect={cotizacionSelect}/>
            </Box>
        </Modal>
        </div>
  );
